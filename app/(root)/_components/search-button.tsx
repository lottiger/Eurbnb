...
const SearchButton = (): JSX.Element => {
  return (
    <>
      <button
        type="submit"
        className="smx:pl-[25px] hover:cursor-pointer focus:outline-none focus:ring-2 focus:ring-gray-700 hover:bg-gray-200 p-2 rounded-lg"
        aria-label="Search"
      >
        <svg
